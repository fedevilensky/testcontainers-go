...
type ContainerRequest struct {
	...
	EnpointSettingsModifier  func(map[string]*network.EndpointSettings) // Deprecated: Use EndpointSettingsModifier for the network settings before container creation
